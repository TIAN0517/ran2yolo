...
static DWORD s_InvSlotCurrent  = Offsets::Inventory::InvSlot_Current;
static DWORD s_InvSlotData     = Offsets::Inventory::InvSlot_Data;
static int   s_InvMaxSlots     = Offsets::Inventory::InvMaxSlots;
static DWORD s_InvItemId       = Offsets::Inventory::ItemId_off;
static DWORD s_InvItemCount    = Offsets::Inventory::ItemCount_off;
static DWORD s_InvItemX        = Offsets::Inventory::ItemX_off;
static DWORD s_InvItemY        = Offsets::Inventory::ItemY_off;
static DWORD s_InvSlotStride   = Offsets::Inventory::SlotStride;
...
static void ResetToDefaults() {
    ...
    s_InvSlotCurrent = Offsets::Inventory::InvSlot_Current;
    s_InvSlotData = Offsets::Inventory::InvSlot_Data;
    s_InvMaxSlots = Offsets::Inventory::InvMaxSlots;
    s_InvItemId = Offsets::Inventory::ItemId_off;
    s_InvItemCount = Offsets::Inventory::ItemCount_off;
    s_InvItemX = Offsets::Inventory::ItemX_off;
    s_InvItemY = Offsets::Inventory::ItemY_off;
...
DWORD OffsetConfig::InvSlotCurrent() { return s_InvSlotCurrent; }
DWORD OffsetConfig::InvSlotData()   { return s_InvSlotData; }
...
DWORD OffsetConfig::InvItemX()      { return s_InvItemX; }
DWORD OffsetConfig::InvItemY()      { return s_InvItemY; }
