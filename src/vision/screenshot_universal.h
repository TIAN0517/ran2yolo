...
// ============================================================
// Legacy API Compatibility (for target_lock.cpp)
// ============================================================
// Capture client area using PrintWindow + PW_RENDERFULLCONTENT
// Returns HDC (caller must NOT DeleteDC)
// Sets outHdc, outBmp, outW, outH
HDC CaptureWindowClient(HWND hWnd, HDC* outHdcMem, HBITMAP* outBmp, int* outW, int* outH);

// Free resources from CaptureWindowClient
void FreeCapture(HDC hdcMem, HBITMAP hBmp);
