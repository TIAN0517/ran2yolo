...
// ============================================================
HDC ScreenshotUniversal::CaptureWindowClient(HWND hWnd, HDC* outHdcMem, HBITMAP* outBmp, int* outW, int* outH) {
    if (!outHdcMem || !outBmp || !outW || !outH) return NULL;
    *outHdcMem = NULL;
    *outBmp = NULL;
    *outW = 0;
    *outH = 0;
...
void ScreenshotUniversal::FreeCapture(HDC hdcMem, HBITMAP hBmp) {
